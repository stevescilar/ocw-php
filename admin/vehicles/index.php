...
<script>
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Add New vehicle","vehicles/manage_vehicle.php")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Update vehicle Details","vehicles/manage_vehicle.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
